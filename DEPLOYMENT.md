...
sudo service unicorn_calendar <start|stop|restart>
sudo service sidekiq_calendar <start|stop>
```
...
```
/home/deployer/apps/calendar/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_calendar restart
sudo service sidekiq_calendar stop
sudo service sidekiq_calendar start
```
